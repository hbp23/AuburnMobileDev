...
class FavoritesViewModel : ObservableObject {
    ...
    var favoritedCities: [CityModel] { cities.filter { $0.isFavorite } }
    var favoritedHobbies: [HobbyModel] { hobbies.filter { $0.isFavorite } }
    var favoritedBooks: [BookModel] { books.filter { $0.isFavorite } }
